**안녕하세요** </br>
상상스퀘어 백앤드개발자에 지원한 정지민입니다 :)</br>
과제 요구사항에 따라 개발한 결과물을 제출합니다. </br>
요구사항에 최대한 부합하고 각 API의 오류를 최소화하여 안정성 있는 프로그램을 구현하고자 하였으며, 중복되는 소스코드를 줄이고 모듈화하며 재사용성과 구조화를 중요시하였습니다. </br>
테스트 중 궁금한 사항 혹은 의문점이 있으시면 편하게 연락 주시면 감사하겠습니다 !</br>
**연락처** : 010-4019-1169</br></br>
